...
const NavBar = () => {
  ...
  return (
    <header className="fixed top-0 right-0 w-[calc(100%-16rem)] h-16 flex justify-between items-center px-8 z-40 bg-surface-container-low dark:bg-slate-900 border-none">
      ...
      <div className="flex items-center gap-6">
        ...
        <div
          className="relative flex items-center gap-3 pl-4 border-l border-outline-variant/30"
          ref={dropdownRef}
        >
          ...
          >
            <img
              ...
              className="w-10 h-10 rounded-full border-2 border-surface-container-highest cursor-pointer"
          ...
          {dropdownOpen && (
            <div className="absolute right-0 top-12 w-48 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 py-1 z-50">
              <button
                ...
                onClick={() => {
                  setDropdownOpen(false);
                  // navigate("/perfil") o tu lógica aquí
                }}
              >
