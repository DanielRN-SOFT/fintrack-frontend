      ...
      <main className="ml-64 mt-16 p-8 min-h-screen bg-surface">
        ...
        <div className="flex justify-between items-end mb-8">
          ...
          <div className="flex gap-4">
            ...
            <button className="px-5 py-2.5 bg-secondary text-white font-bold rounded-lg flex items-center gap-2 shadow-lg shadow-secondary/20 hover:scale-[0.98] transition-all">
        ...
        {/* <!-- Filter Bar --> */}
        <section className="bg-surface-container-lowest rounded-xl p-4 mb-6 flex items-center gap-4 shadow-sm border border-outline-variant/10">
          ...
          <div className="flex items-center bg-surface p-1 rounded-lg">
            ...
            <button className="px-4 py-1.5 text-xs font-bold rounded-md text-on-surface-variant hover:bg-surface-container-highest">
              Ingreso
            </button>
            <button className="px-4 py-1.5 text-xs font-bold rounded-md text-on-surface-variant hover:bg-surface-container-highest">
              Egreso
          ...
          <div className="relative group">
            <select className="appearance-none bg-surface border-none rounded-lg py-2 pl-4 pr-10 text-sm font-medium focus:ring-1 focus:ring-primary/20">
          ...
          <div className="flex items-center gap-2 bg-surface px-3 py-2 rounded-lg">
            ...
            <input
              className="bg-transparent border-none text-xs font-medium p-0 focus:ring-0"
              type="date"
            />
          ...
          <button className="text-xs font-bold text-primary hover:underline px-2 transition-all">
            Limpiar filtros
          </button>
        </section>
        {/* <!-- Summary Bar --> */}
